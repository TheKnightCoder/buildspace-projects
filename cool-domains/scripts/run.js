const main = async () => {
  ...
  // set record to an website ip address
  txn = await domainContract.setRecord("doom", "192.168.0.1");
  await txn.wait();
  console.log("get doom record (IP Address):", await domainContract.getRecord("doom"));
